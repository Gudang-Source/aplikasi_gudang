        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="<?php echo ($this->uri->segment(1) === "user") ? "active" : ""?>"><a href="<?php echo site_url('user')?>"><i class="fa fa-home"></i> <span>Home</span></a></li>
                    <li class="<?php echo ($this->uri->segment(1) === "inventory") ? "active" : ""?>"><a href="<?php echo site_url('inventory')?>"><i class="fa fa-home"></i> <span>Input Item</span></a></li>
                    <!-- <li class="menu-list">
